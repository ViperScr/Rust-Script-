...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
   ...
   // draw->AddLine(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 4), ImVec2(frame_bb.Max.x, frame_bb.Min.y + 4), ImColor(45, 45, 45), 3);
    ...
    RenderTextClipped(ImVec2(grab_bb.Min.x - 15, total_bb.Min.y + 2), ImVec2(grab_bb.Max.x + 14, total_bb.Min.y + 20), value_buf, value_buf_end, NULL, ImVec2(0.5f, 0.5f));

    // Slider grab
    //draw->AddRectFilled(ImVec2(grab_bb.Min.x - 5, frame_bb.Min.y - 4), ImVec2(grab_bb.Max.x + 5, frame_bb.Max.y + 4), ImColor(26, 26, 30), 3);
    //draw->AddRect(ImVec2(grab_bb.Min.x - 5, frame_bb.Min.y - 4), ImVec2(grab_bb.Max.x + 5, frame_bb.Max.y + 4), ImColor(38, 38, 42), 3, 15, 2);
    //draw->AddRect(ImVec2(grab_bb.Min.x - 5, frame_bb.Min.y - 4), ImVec2(grab_bb.Max.x + 5, frame_bb.Max.y + 4), ImColor(14, 14, 16), 3, 15, 1);
    //draw->AddLine(ImVec2(grab_bb.Min.x + 2, frame_bb.Min.y), ImVec2(grab_bb.Min.x + 2, frame_bb.Max.y), ImColor(72, 72, 80));
    //draw->AddLine(ImVec2(grab_bb.Min.x + 5, frame_bb.Min.y), ImVec2(grab_bb.Min.x + 5, frame_bb.Max.y), ImColor(72, 72, 80));
    //draw->AddLine(ImVec2(grab_bb.Min.x + 8, frame_bb.Min.y), ImVec2(grab_bb.Min.x + 8, frame_bb.Max.y), ImColor(72, 72, 80));
